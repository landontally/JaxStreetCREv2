...
<svelte:head>
	...
	<meta name="description" content="Browse our portfolio of available retail and light industrial properties in central Indiana." />
</svelte:head>
                        ...
                        <div class="w-3/5 md:w-2/3 p-4 py-5 flex flex-col justify-between flex-grow">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-4 mt-auto pt-3 border-t border-zinc-100">
                                <button 
                                    ...
                                    class="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 text-[10px] font-bold uppercase text-zinc-500 hover:text-teal-600 transition-colors tracking-widest"
                                >
                                    Focus Map
                                </button>
