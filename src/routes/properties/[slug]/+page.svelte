				...
				{#if property.status === 'Available' || !property.status}
					<div use:reveal class="bg-zinc-950/95 backdrop-blur-xl border border-zinc-800 p-8 rounded-sm shadow-2xl flex flex-col gap-8 relative overflow-hidden">
						...
						<div class="flex flex-col gap-4 relative z-10">
							<a href="mailto:eric@jaxstreetcre.com" class="w-full bg-teal-600 hover:bg-teal-500 text-white text-center font-bold py-4 rounded-sm transition-colors flex items-center justify-center gap-3 uppercase tracking-widest text-xs">
