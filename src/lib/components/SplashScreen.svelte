...
<style>
  @media (prefers-reduced-motion: no-preference) {
    ...
    .animate-slot-down {
      -webkit-animation: slotDown 3s cubic-bezier(0.16, 1, 0.3, 1) forwards;
  ...
  @-webkit-keyframes slotUp {
    ...
    100% { -webkit-transform: translateY(-576px); transform: translateY(-576px); }
  }
  @keyframes slotUp {
  ...
  @-webkit-keyframes slotDown {
    0% { -webkit-transform: translateY(-576px); transform: translateY(-576px); }
